...
algorithm main(output uint8 leds){
    ...
    uint$uint_size$ u1(128);
    uint$uint_size$ u2(127);
    ...
    __display(" 0.875                       = %b %b %b", f2[$float_size-1$,1], f2[$mantissa_size$,$exponant_size$], f2[0,$mantissa_size$]);
    __display(" %d * 0.875          = %b %b %b", u1,f3[$float_size-1$,1], f3[$mantissa_size$,$exponant_size$], f3[0,$mantissa_size$]);*/
    __display("\t%d                 = %d",u2, u3);
